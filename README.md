...
Perhaps the committee would settle for an anecdote wherein 1990 the author as an undergraduate intern at the Lawrence Berkeley Lab, Nuclear Science Division, was fortunate enough to ask, at two separate luncheons, two LBL resident Nobel Laureates Owen Chamberlain and Glenn Seaborg the same question:
...
Quantum teleportation, according to 4D GEM EOS, is determined to be occurring exclusively on the idealism basis of a general information field theory of relative states. The first principle for which being the LHC is entirely energized by the 4D spacetime Einstein-Maxwell electromagnetic stress-energy momentum density pressure tensor and its ATLAS CMS detectors measure only 4D electromagnetic energy density tensor pressure quantum field information to which the literature refers.
